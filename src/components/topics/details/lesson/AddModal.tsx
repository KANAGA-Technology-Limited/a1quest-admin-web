...
function AddModal({ closeModal, reload, open, topic, subTopic }: Props) {
  ...
  const submitValues = async () => {
    try {
      setLoading(true);
      const response = await appAxios.post(`/lessons`, {
  ...
  return (
    <CustomModal isOpen={open} onRequestClose={closeModal} title='Create Lesson'>
